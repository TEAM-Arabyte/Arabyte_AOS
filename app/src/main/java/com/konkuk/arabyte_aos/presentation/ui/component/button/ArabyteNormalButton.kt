...
@Composable
fun ArabyteNormalButton(buttonText: String, modifier: Modifier = Modifier, clickable: Boolean = true, buttonClicked: () -> Unit = {}) {
    Text(
        modifier = modifier
            .fillMaxWidth()
...
private fun ArabyteNormalButtonPreview() {
    Column {
        ...
        ArabyteNormalButton(buttonText = "Button", clickable = false)
    }
}