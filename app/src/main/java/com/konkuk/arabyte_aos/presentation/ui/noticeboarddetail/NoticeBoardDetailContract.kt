...
class NoticeBoardDetailContract {
    data class NoticeBoardDetailUiState(
        ...
        val noticeBoardDetail: NoticeBoardDetail = NoticeBoardDetail(
            profileImage = "",
            nickname = "나야알바",
            writeDate = "2025/04/21/16:30",
            title = "최악의 알바 후기... 다들 조심하세요!",
            content = "솔직히 이렇게까지 힘들 줄 몰랐어요. 가게 사장님은 약속한 시급보다 적게 주고, 근무 환경도 엉망이었어요... 여러분들은 알바 구하실 때 꼭 이건 알고 가세요.\n" +
    ...
    sealed class NoticeBoardDetailEvent : UiEvent {
        data object LoadNoticeBoardDetail : NoticeBoardDetailEvent()
    }
}
