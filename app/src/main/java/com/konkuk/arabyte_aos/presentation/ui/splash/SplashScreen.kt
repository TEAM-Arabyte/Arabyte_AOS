...
fun SplashScreen(
    ...
    Column(
        ...
        Spacer(modifier = Modifier.weight(225f))
        Icon(imageVector = ImageVector.vectorResource(R.drawable.ic_all_logo), contentDescription = null, tint = Color.Unspecified)
        ...
        Spacer(modifier = Modifier.weight(369f))
    }
}
