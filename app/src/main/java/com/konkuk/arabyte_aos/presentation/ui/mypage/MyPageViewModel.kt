...
constructor(
    ...
    private fun postEnrollContract(url: String) {
        viewModelScope.launch {
            postContractVerificationUseCase(
                ...
                addContract(companyName = currentState.companyName, valid = result)
                setState { copy(companyName = "", addContractViewVisible = result, contractImageUri = "", contractUploadState = LoadState.Success) }
            }.onFailure {
    ...
    private fun addContract(companyName: String, valid: Boolean) {
